...
public class resultadosAleatorios : MonoBehaviour
{
    ...
    public void generarAleatorios(){
        ...
        TestManager.metricas.veces_marcado_billete = Random.Range(1,10);
        TestManager.metricas.veces_devuelto_billete = Random.Range(0,TestManager.metricas.veces_marcado_billete);
        TestManager.metricas.cantidad_minima_billetes = Random.Range(3,12);
        ...
        TestManager.metricas.contador_cruces_validos = Random.Range(1,5);
