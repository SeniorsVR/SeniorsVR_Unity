    ...
    public void Press()
    {
        ...
        switch (tipo)
        {
            ...
            case GraphRegresionTipo.Productos:
                ...
                desc = "Puntaje obtenido usando el ratio entre la cantidad de veces que recogió y devolvió un objeto y la cantidad óptima de acciones que se debían realizar.";
                break;
